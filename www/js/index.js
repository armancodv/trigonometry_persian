class Model {
    constructor() {
        this.version = '4.0.0';
        this.package = 'com.armanco.trigonometry_persian';
        this.homepage = 'https://arman.co.com/';
        this.api = 'https://arman.co.com/api/applist_formula.php';
        this.addId = 'ca-app-pub-4301546764905932/1105452517';
        this.title = 'مثلثات';
        this.subTitle = 'مرجع و ماشین حساب';
        this.description = 'این برنامه دارای دو بخش ماشین حساب مثلثاتی و اتحادهای مثلثثاتی می باشد.';
        this.page = 1;
        this.category = 0;

        this.categoriesTitles = ['مبانی','بازتاب و انتقال','جمع و تفاضل زوایا','زاویه 2 برابر','زاویه 3 برابر','نصف کمان','توان','ضرب به جمع','جمع به ضرب','معکوس مثلثاتی','مشتق','نمایی'];
        this.categoriesThumbs = ['base', 'sym', 'sum', 'dou', 'tri', 'half', 'pow', 'pro', 'sum', 'inv', 'der', 'exp'];

        this.categoryTitles = [
            ['سینوس','کسینوس','تانژانت','کسکانت','سکانت','کتانژانت','فیثاغورس'],
            ['بازتاب در θ=0','بازتاب در θ=π/4','بازتاب در θ=π/2','انتقال π/2','انتقال π','انتقال 2π'],
            ['سینوس','کسینوس','تانژانت','سینوس معکوس','کسینوس معکوس','تانژانت معکوس'],
            ['سینوس','کسینوس','تانژانت','کتانژانت'],
            ['سینوس','کسینوس','تانژانت','کتانژانت'],
            ['سینوس','کسینوس','تانژانت','کتانژانت'],
            ['سینوس توان دوم','کسینوس توان دوم','سینوس توان سوم','کسینوس توان سوم','سینوس توان چهارم','کسینوس توان چهارم'],
        ...
        this.calculatorsTitles = ['ماشین حساب مثلثاتی', 'ماشین حساب معکوس مثلثاتی'];
        ...
        this.outputsTitles = [
            ['سینوس', 'کسینوس', 'تانژانت', 'کتانژانت', 'کسکانت', 'سکانت'],
            ['سینوس معکوس', 'کسینوس معکوس', 'تانژانت معکوس', 'کتانژانت معکوس', 'کسکانت معکوس', 'سکانت معکوس']
        ];
